...
import {AddChat, AddGroup, GetChat} from '../../../../graphql';
    ...
    combineLatest(this.route.params, this.route.queryParams,
      ...
      .subscribe(({params: {id: chatId}, queryParams: {oui}}) => {
        ...
        if (this.optimisticUI) {
          ...
          this.chatsService.addChat$.subscribe(({data}) => {
            this.chatId = (<AddChat.Mutation>data).addChat ? (<AddChat.Mutation>data).addChat.id : (<AddGroup.Mutation>data).addGroup.id;
